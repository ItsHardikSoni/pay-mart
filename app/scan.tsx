...
const styles = StyleSheet.create({
  ...
  discountPill: { backgroundColor: Colors.secondary, paddingHorizontal: 12, paddingVertical: 6, borderRadius: 16 },
  ...
  scanLine: { width: '80%', height: 2, backgroundColor: Colors.secondary, position: 'absolute' },
